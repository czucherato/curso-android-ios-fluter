...
class ContactHelper {
  ...
  Future<List<Contact>> getAllContacts() async {
    ...
    listMap.forEach((element) => contacts.add(Contact.fromMap(element)));
    return contacts;
  }

  Future<int> getNumber() async {
    Database dbContact = (await db)!;
    return Sqflite.firstIntValue(await dbContact.rawQuery("SELECT COUNT($idColumn) FROM $contactTable")) ?? 0;
  }
...
class Contact {
  ...
  @override
  String toString() {
    return "Contact(id: ${this.id}, name: ${this.name}, email: ${this.email}, phone: ${this.phone}, img: ${this.img})";
  }
}